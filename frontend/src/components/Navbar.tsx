      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6">
        <div className="h-16 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-6 text-sm">
            ...
            <NavLink to="/tour" className={({ isActive }) => `hover:text-gray-900 ${isActive ? 'text-gray-900 font-medium' : 'text-gray-600'}`}>Tour</NavLink>
            ...
            <NavLink to="/assistant" className={({ isActive }) => `hover:text-gray-900 ${isActive ? 'text-gray-900 font-medium' : 'text-gray-600'}`}>Assistant</NavLink>
            <NavLink to="/add-monastery" className={({ isActive }) => `px-3 py-1.5 rounded bg-indigo-600 text-white hover:bg-indigo-700 ${isActive ? 'ring-2 ring-indigo-300' : ''}`}>Add</NavLink>
          </div>
        </div>
      </div>
    </nav>
